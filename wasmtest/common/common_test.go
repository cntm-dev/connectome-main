...
func TestTestCase(t *testing.T) {
	...
	assert.Equal(t, string(encoded), `{"env":{"witness":["AFmseVrdL9f9oyCzZefL9tG6UbvhPbdYzM"]},"needccntmext":false,"method":"func1","param":"int:100, bool:true","expected":"int:10","notify":"","jsonabi":""}`)
}
