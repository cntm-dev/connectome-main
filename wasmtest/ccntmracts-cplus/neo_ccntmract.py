...
from cntmology.interop.Ontology.Wasm import InvokeWasm
...
def testcallwasm(textCcntmext):
    ...
    address = textCcntmext[0]["test_add.wasm"]
...
def testcase():
    return '''
    [
        [{"needccntmext":false,"env":{"witness":[]}, "method":"add", "param":"[int:1,int:2]", "expected":"int:3"},
        {"needccntmext":true,"env":{"witness":[]}, "method":"callwasm", "param":"[int:1]", "expected":"int:5"}
        ]
    ]'''
