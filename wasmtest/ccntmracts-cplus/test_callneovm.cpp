...
class hello: public ccntmract {
	...
	address callneo_address(test_conext &tc) {
		address res;
		address test_neo = tc.addrmap["neo_ccntmract.avm"];
		call_neo_ccntmract(test_neo, pack_neoargs("bytearray", test_neo), res);

		check(res == test_neo, "get bytearray result wrcntm");
		notify_event(res);
		return res;
	}
	...
	address callneo_vector(test_conext &tc) {
		...
		check(test_neo == com, "get bytearray result wrcntm");
		notify_event(com);
		return com;
	}
	...
	string callneo_string(test_conext &tc) {
		string res;
		address test_neo = tc.addrmap["neo_ccntmract.avm"];
		call_neo_ccntmract(test_neo, pack_neoargs("string", "test_callneo"), res);
	...
	bool callneo_bool(test_conext &tc) {
		bool res;
		address test_neo = tc.addrmap["neo_ccntmract.avm"];
		call_neo_ccntmract(test_neo, pack_neoargs("boolean", std::tuple<bool, bool>(true, false)), res);
		check(res == true, "return error");
		notify_event(res);

		call_neo_ccntmract(test_neo, pack_neoargs("boolean", std::tuple<bool, bool>(false, false)), res);
		check(res == false, "return error");
		notify_event(res);


		call_neo_ccntmract(test_neo, pack_neoargs("boolean", std::tuple<bool, bool>(false, true)), res);
		check(res == false, "return error");
		notify_event(res);


		call_neo_ccntmract(test_neo, pack_neoargs("boolean", std::tuple<bool, bool>(true, true)), res);
		check(res == true, "return error");
		notify_event(res);
		return res;
	}
	...
	H256 callneo_h256(test_conext &tc) {
		...
		call_neo_ccntmract(test_neo, pack_neoargs("H256", cbhash), res);
	...
	int128_t callneo_int(test_conext &tc) {
		...
		call_neo_ccntmract(test_neo, pack_neoargs("intype", 9), res);
		check(res = 9 + 0x101, "return error");
		notify_event(res);

		// here test overflow error. should be panic.
		//int32_t res_t = 0;
		//call_neo_ccntmract(test_neo, pack_neoargs("intype", int128_t(std::numeric_limits<int64_t>::min())), res_t);
	...
	void  callneo_tuples(test_conext &tc) {
		...
		address test_neo = tc.addrmap["neo_ccntmract.avm"];
		call_neo_ccntmract(test_neo, pack_neoargs("std", tupleargs), res);
	...
	void callneo_vectorT(test_conext &tc) {
		...
		address test_neo = tc.addrmap["neo_ccntmract.avm"];
		call_neo_ccntmract(test_neo, pack_neoargs("std", arg1), res);
	...
	void callneo_array1(test_conext &tc) {
		...
		address test_neo = tc.addrmap["neo_ccntmract.avm"];
		call_neo_ccntmract(test_neo, pack_neoargs("std", ttt4), res);
	...
	string testcase(void) {
		return string(R"(
		[
				[{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_address", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_vector", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_string", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_bool", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_h256", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_tuples", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_vectorT", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_list", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_deque", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_pair", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_set", "param":"", "expected":""},
				{"needccntmext":true,"env":{"witness":[]}, "method":"callneo_array1", "param":"", "expected":""}
				]
		]
		)");
	}
...
cntmIO_DISPATCH( hello,(callneo_h256)(callneo_string)(callneo_address)(callneo_vector)(callneo_bool)(callneo_int)(callneo_vectorT)(callneo_tuples)(callneo_list)(callneo_deque)(callneo_pair)(callneo_set)(callneo_array1)(testcase))
