...
func getBridgeCcntmract(ccntmract []Item) (bridge common3.ConAddr, wingErc20 common3.ConAddr, wingOep4 common3.ConAddr) {
...
func bridgeTest(bridge, wingOep4, wingErc20 common3.ConAddr, database *ledger.Ledger, acct *account.Account) {
	...
	ccntmractInit(admin, bridge, wingOep4, wingErc20, database, acct)
	txNonce := int64(2)
...
func ccntmractInit(admin common.Address, bridge, wingOep4, wingErc20 common3.ConAddr, database *ledger.Ledger, acct *account.Account) {
	//wing oep4 init
	param := "int:1"
	testCcntmext := common3.TestCcntmext{
		Admin:   admin,
