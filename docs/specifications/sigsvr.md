...
Note:
When sigsvr starts, it will seek the native ccntmract abi under "./cmd/abi/native" in the current directory. If there is no abi for this ccntmract in the naitve directory, then it will return a 1007 error.
