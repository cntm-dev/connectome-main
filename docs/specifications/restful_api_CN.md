...
| [get_ccntmract_state](#10-get_ccntmract_state) | GET /api/v1/ccntmract/:hash | 得到合约状态 |
...
| [get_unboundcntm](#17-get_unboundcntm) | GET /api/v1/unboundcntm/:addr | 返回该账户未提取的cntm数量 |
...
| [get_balancev2](#25-get_balancev2) | GET /api/v1/balance/:addr | 得到该地址的账户的余额,cntm精度9,cntm精度18 |
| [get_allowancev2](#26-get_allowancev2) | GET /api/v1/allowance/:asset/:from/:to | 返回允许从from账户转出到to账户的额度,cntm精度9,cntm精度18 |
...
得到允许从from账户转出到to账户的额度。cntm精度9，cntm精度18
