...
| [subscribe](#2-subscribe) | [CcntmractsFilter],[SubscribeEvent],[SubscribeJsonBlock],[SubscribeRawBlock],[SubscribeBlockTxHashs] | subscribe service |
| [getconnectioncount](#3-getconnectioncount) |  | get the current number of connections for the node |
| [getblocktxsbyheight](#4-getblocktxsbyheight) | height | return all transaction hash ccntmained in the block corresponding to this height |
...
| [sendrawtransaction](#10-sendrawtransaction) | data,[PreExec] | Send transaction. Set PreExec=1 if want prepare exec smart ccntmract |
| [getstorage](#11-getstorage) | hash,key | return the stored value according to the ccntmract script hashes and stored key |
| [getbalance](#12-getbalance) | address | return the balance of base58 account address |
| [getccntmract](#13-getccntmract) | hash | According to the ccntmract address hash, query the ccntmract information |
| [getsmartcodeeventbyheight](#14-getsmartcodeeventbyheight) | height | return smart ccntmract event list by height |
| [getsmartcodeeventbyhash](#15-getsmartcodeeventbyhash) | hash | return ccntmract event by transaction hash |
...
| [getunboundcntm](#21-getunboundcntm) | address | get unbound cntm of this address |
...
| [getgrantcntm](#26-getgrantcntm) |  | get grant cntm |
| [getsyncstatus](#27-getsyncstatus) |  | gets the synchronization status of the node |
| [getbalancev2](#12-getbalancev2) | address | return balance of the account address,cntm decimals is 9,cntm decimals is 18 |
| [getallowancev2](#20-getallowancev2) | asset, from, to | return the allowance from transfer-from accout to transfer-to account, cntm decimals is 9,cntm decimals is 18  |
...
```
{
    ...
    "Version": "1.0.0",
    "Id":12345, //optional
    "CcntmractsFilter":["ecceb5863d20b9d05412a5f2641167e716628932"], //optional
...
```
{
    ...
    "Error": 0,
    "Result": {
        "CcntmractsFilter":["ecceb5863d20b9d05412a5f2641167e716628932"],
        "SubscribeEvent":false,
...
Send transaction. Set PreExec=1 if want prepare exec smart ccntmract.
...
You can use the cntmology-go-sdk to generate hex code, reference to [example](rpc_api.md#8-sendrawtransaction)
...
Returns the stored value according to the ccntmract address hash and stored key.

ccntmract address hash could be generated by follow function
...
According to the ccntmract address hash, query the ccntmract information.
...
Get smart ccntmract event list by height.

Get a list of transaction with smarte ccntmract event based on height.
...
Get ccntmract event by transaction hash.
