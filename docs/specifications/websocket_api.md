...
| [getblocktxsbyheight](#5-getblocktxsbyheight) | height | return all transaction hash ccntmained in the block corresponding to this height |
...
| [sendrawtransaction](#11-sendrawtransaction) | data,[PreExec] | Send transaction. Set PreExec=1 if want prepare exec smart ccntmract |
| [getstorage](#12-getstorage) | hash,key | return the stored value according to the ccntmract script hashes and stored key |
| [getbalance](#13-getbalance) | address | return the balance of base58 account address |
| [getccntmract](#14-getccntmract) | hash | According to the ccntmract address hash, query the ccntmract information |
| [getsmartcodeeventbyheight](#15-getsmartcodeeventbyheight) | height | return smart ccntmract event list by height |
| [getsmartcodeeventbyhash](#16-getsmartcodeeventbyhash) | hash | return ccntmract event by transaction hash |
...
| [getunboundcntm](#22-getunboundcntm) | address | get unbound cntm of this address |
