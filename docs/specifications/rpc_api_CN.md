...
| [getversion](#10-getversion) |  | 得到运行的cntmology版本 |  |
| [getccntmractstate](#11-getccntmractstate) | script_hash,[verbose] | 根据合约地址，得到合约信息 |  |
...
| [getunboundcntm](#20-getunboundcntm) | address | 返回该账户未提取的cntm |  |
