...
| [get_storage](#8-get_storage) | GET /api/v1/storage/:hash/:key| return the stored value according to the ccntmract address hash and stored key|
| [get_balance](#9-get_balance) | GET /api/v1/balance/:addr | return balance of the account address |
| [get_ccntmract_state](#10-get_ccntmract_state) | GET /api/v1/ccntmract/:hash | return ccntmract state according to the ccntmract address hash |
...
| [get_unboundcntm](#17-get_unboundcntm) | GET /api/v1/unboundcntm/:addr | return the number of unbound cntm of given address |
...
```
curl -i http://server:port/api/v1/ccntmract/0100000000000000000000000000000000000000
```
