...
| [get_storage](#9-get_storage) | GET /api/v1/storage/:hash/:key| return the stored value according to the ccntmract address hash and stored key|
| [get_balance](#10-get_balance) | GET /api/v1/balance/:addr | return balance of the account address |
| [get_ccntmract_state](#11-get_ccntmract_state) | GET /api/v1/ccntmract/:hash | return ccntmract state according to the ccntmract address hash |
...
| [get_unboundcntm](#18-get_unboundcntm) | GET /api/v1/unboundcntm/:addr | return the number of unbound cntm of given address |
...
| [get_version](#21-get_version) |  GET /api/v1/version | return the version of cntmology |
| [post_raw_tx](#22-post_raw_tx) | post /api/v1/transaction?preExec=0 | send transaction to cntmology network |
...
```
> Note: result is the smart ccntmract event list.
...
Send transaction. Set preExec=1 if want prepare exec smartccntmract.
