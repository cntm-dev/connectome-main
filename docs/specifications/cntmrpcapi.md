...
| NextBookKeeper | UInt160 | Accounting ccntmract hash value for the next block |
| BookKeepers |  ||
| SigData |||
...
| NetworkFee | lcntm | neitwork fees |
...
```
{
    ...
    "result": {
        ...
        "storage": false,
        "name": "AgencyCcntmract",
        "code_version": "2.0.1-preview1",
        "author": "Erik Zhang",
        "email": "erik@antshares.org",
        "description": "Agency Ccntmract 2.0"
    }
}
```
