...
| [sendrawtransaction](#11-sendrawtransaction) | data,[PreExec] | 向cntmology网络发送交易, 如果 preExec=1，则交易为预执行 |
| [getstorage](#12-getstorage) | hash,key | 通过合约地址哈希和键得到对应的值 |
| [getbalance](#13-getbalance) | address | 得到该地址的账户的余额 |
| [getccntmract](#14-getccntmract) | hash | 根据合约地址哈希得到合约信息 |
...
| [getunboundcntm](#22-getunboundcntm) | address | 返回该账户未提取的cntm数量 |
