...
* [Ontology cli 使用说明](#cntmology-cli-使用说明)
	* [1、启动和管理Ontology节点](#1启动和管理cntmology节点)
		* [1.1 启动参数](#11-启动参数)
...
```
./cntmology --enableconsensus --disablerpc --disableeventlog
```
...
```
./cntmology --enableconsensus --nodeport=XXX --rpcport=XXX
```
#### 1.2.5 单节点测试网络部署
