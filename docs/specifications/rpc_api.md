...
| [getstorage](#9-getstorage) | script_hash, key | Returns the stored value according to the ccntmract address hash and stored key. |  |
| [getversion](#10-getversion) |  | Get the version information of the node |  |
| [getccntmractstate](#11-getccntmractstate) | script_hash,[verbose] | According to the ccntmract address hash, query the ccntmract information. |  |
...
| [getunboundcntm](#20-getunboundcntm) | address | return unbound cntm |  |
