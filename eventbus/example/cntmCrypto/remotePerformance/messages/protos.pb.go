...
// source: github.com/Ontology/eventbus/example/cntmCrypto/remotePerformance/messages/protos.proto

/*
	Package messages is a generated protocol buffer package.

	It is generated from these files:
		github.com/Ontology/eventbus/example/cntmCrypto/remotePerformance/messages/protos.proto
...
func (m *Pcntm) Reset()                    { *m = Pcntm{} }
func (*Pcntm) ProtoMessage()               {}
func (*Pcntm) Descriptor() ([]byte, []int) { return fileDescriptorProtos, []int{3} }

func (m *Pcntm) GetIfOK() string {
	if m != nil {
		return m.IfOK
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*Pcntm)(nil), "messages.Pcntm")
}
...
func (this *Pcntm) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
...
func (this *Pcntm) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&messages.Pcntm{")
...
func (m *Pcntm) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Pcntm) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (this *Pcntm) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Pcntm{`,
...
func (m *Start) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field PriKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Pcntm) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Pcntm: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Pcntm: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field IfOK", wireType)
			}
...
func init() {
	proto.RegisterFile("github.com/Ontology/eventbus/example/cntmCrypto/remotePerformance/messages/protos.proto", fileDescriptorProtos)
}
