...
func (state *endpointSupervisor) Receive(ctx actor.Ccntmext) {
...
func (state *endpointSupervisor) spawnEndpointWriter(address string, ctx actor.Ccntmext) *actor.PID {
	props := actor.
...
func (state *endpointSupervisor) spawnEndpointWatcher(address string, ctx actor.Ccntmext) *actor.PID {
	props := actor.
