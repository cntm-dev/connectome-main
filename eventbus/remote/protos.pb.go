...
import (
	ccntmext "golang.org/x/net/ccntmext"
...
type RemotingClient interface {
	Connect(ctx ccntmext.Ccntmext, in *ConnectRequest, opts ...grpc.CallOption) (*ConnectResponse, error)
	Receive(ctx ccntmext.Ccntmext, opts ...grpc.CallOption) (Remoting_ReceiveClient, error)
}
...
func (c *remotingClient) Connect(ctx ccntmext.Ccntmext, in *ConnectRequest, opts ...grpc.CallOption) (*ConnectResponse, error) {
...
func (c *remotingClient) Receive(ctx ccntmext.Ccntmext, opts ...grpc.CallOption) (Remoting_ReceiveClient, error) {
...
type RemotingServer interface {
	Connect(ccntmext.Ccntmext, *ConnectRequest) (*ConnectResponse, error)
...
func _Remoting_Connect_Handler(srv interface{}, ctx ccntmext.Ccntmext, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx ccntmext.Ccntmext, req interface{}) (interface{}, error) {
...
func (m *MessageBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field TypeNames", wireType)
			}
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field TargetNames", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field Envelopes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *MessageEnvelope) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field TypeId", wireType)
			}
			m.TypeId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field MessageData", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field Target", wireType)
			}
			m.Target = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field Sender", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field SerializerId", wireType)
			}
			m.SerializerId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field MessageHeader", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *MessageHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field HeaderData", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ActorPidRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field Name", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field Kind", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ActorPidResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field Pid", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field StatusCode", wireType)
			}
			m.StatusCode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ConnectResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field DefaultSerializerId", wireType)
			}
