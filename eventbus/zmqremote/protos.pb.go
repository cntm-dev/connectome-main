...
// source: github.com/cntmIO/eventbus/zmqremote/protos.proto

/*
	Package zmqremote is a generated protocol buffer package.

	It is generated from these files:
		github.com/cntmIO/eventbus/zmqremote/protos.proto
...
func (m *MsgData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrcntm wireType = %d for field MsgType", wireType)
			}
			m.MsgType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func init() {
	proto.RegisterFile("github.com/cntmIO/eventbus/zmqremote/protos.proto", fileDescriptorProtos)
}
