...
// A ReceiveTimeout message is sent to an actor after the Ccntmext.ReceiveTimeout duration has expired
...
// Restart is message sent by the actor system to ccntmrol the lifecycle of an actor
type Restart struct{}
...
func (*ccntminuation) SystemMessage() {}
