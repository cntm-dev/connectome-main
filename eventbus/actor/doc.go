...
using the Ccntmext.Sender method, which returns the PID of of the sender.

For synchronous communication, an actor will use a Future and wait for the result before ccntminuing. To send a message
