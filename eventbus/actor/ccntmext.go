...
//Ccntmext ccntmains ccntmextual information for actors
type Ccntmext interface {
	...
	// Actor returns the actor associated with this ccntmext
	Actor() Actor

	AwaitFuture(f *Future, ccntminuation func(res interface{}, err error))
}
