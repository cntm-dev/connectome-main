...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash1 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
...
echo "Transfer cntm Hash: $transfer"
sleep 6

output=$($CMD asset --transfer --asset $cntmAsset --to $programhash2 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash3 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash4 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash5 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash6 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash7 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash8 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash9 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash10 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash11 --value 10000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
...
# asset transfer
output=$($CMD asset --transfer --asset $cntmAsset --to $programhash --value 100000000000000000 --wallet $WALLET  --netWorkFee 0 --password $PASSWD)
if (( $? != 0 )); then
    echo "asset transfer failed"
    exit 1
fi
