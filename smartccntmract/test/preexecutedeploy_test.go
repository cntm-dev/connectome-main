...
func TestPreExecuteCcntmractWasmDeploy(t *testing.T) {
	...
	_, err = testLedgerStore.PreExecuteCcntmract(tx)
	assert.EqualError(t, err, "this code is wasm binary. can not deployed as neo ccntmract")
