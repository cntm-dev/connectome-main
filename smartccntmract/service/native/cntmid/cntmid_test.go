...
func CaseRegID(t *testing.T, n *native.NativeService) {
	...
	if err := regID(n, "did:cntm:abcd1234", a); err == nil {
...
func CaseOwnerSize(t *testing.T, n *native.NativeService) {
	...
	_, err = insertPk(n, enc, buf, []byte("ccntmroller"), true, false)
	if err == nil {
...
func CaseGetDocument(t *testing.T, n *native.NativeService) {
	...
	if err := regID(n, "did:cntm:TVuSUjQQYsbK9WBnikeEgVy6GuWQ9qz1iW", a2); err != nil {
		t.Fatal("register ID error", err)
	}
	if err := regID(n, "did:cntm:TYtNor9XRNYXe2XrM4abzaRbd37WgGKDC1", a2); err != nil {
		t.Fatal("register ID error", err)
	}
	if err := regID(n, "did:cntm:TUgmqNEqDJSpN5AgcV2mQ4HtG4qVNVWb89", a2); err != nil {
		t.Fatal("register ID error", err)
	}
