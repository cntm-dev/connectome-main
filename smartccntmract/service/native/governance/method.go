...
func splitNodeFee(native *native.NativeService, ccntmract common.Address, peerPubkey string, peerAddress common.Address,
	...
	//get peerCost
	peerCost, stakeCost, err := getPeerCost(native, ccntmract, peerPubkey)
	if err != nil {
