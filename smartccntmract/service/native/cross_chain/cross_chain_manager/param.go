...
func (this *CreateCrossChainTxParam) Serialization(sink *common.ZeroCopySink) {
	...
	utils.EncodeVarBytes(sink, this.ToCcntmractAddress)
...
func (this *CreateCrossChainTxParam) Deserialization(source *common.ZeroCopySource) error {
	...
	toCcntmractAddress, err := utils.DecodeVarBytes(source)
	if err != nil {
		return fmt.Errorf("CreateCrossChainTxParam deserialize toCcntmractAddress error:%s", err)
	}
