...
func (this *InitCcntmractAdminParam) Serialization(sink *common.ZeroCopySink) {
	sink.WriteVarBytes(this.AdminOntID)
}

func (this *InitCcntmractAdminParam) Deserialization(source *common.ZeroCopySource) error {
...
func (this *TransferParam) Serialization(sink *common.ZeroCopySink) {
	serializeAddress(sink, this.CcntmractAddr)
...
func (this *TransferParam) Deserialization(source *common.ZeroCopySource) error {
	var err error
	if this.CcntmractAddr, err = utils.DecodeAddress(source); err != nil {
		return err
	}
	var irregular, eof bool
...
func (this *FuncsToRoleParam) Serialization(sink *common.ZeroCopySink) {
	utils.EncodeAddress(sink, this.CcntmractAddr)
	sink.WriteVarBytes(this.AdminOntID)
