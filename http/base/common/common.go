...
func NewNativeInvokeTransaction(gasPirce, gasLimit uint64, ccntmractAddress common.Address, version byte, method string, params []interface{}) (*types.Transaction, error) {
