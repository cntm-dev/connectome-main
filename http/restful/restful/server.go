...
func (this *restServer) registryMethod() {
	...
	getMethodMap := map[string]Action{
		...
		Api_GetCcntmractState:     {name: "getccntmract", handler: rest.GetCcntmractState},
...
func (this *restServer) getPath(url string) string {
	...
	if strings.Ccntmains(url, strings.TrimRight(Api_GetblkTxsByHeight, ":height")) {
		return Api_GetblkTxsByHeight
	} else if strings.Ccntmains(url, strings.TrimRight(Api_Getblkbyheight, ":height")) {
		return Api_Getblkbyheight
	} else if strings.Ccntmains(url, strings.TrimRight(Api_Getblkhash, ":height")) {
		return Api_Getblkhash
	} else if strings.Ccntmains(url, strings.TrimRight(Api_Getblkbyhash, ":hash")) {
	...
	} else if strings.Ccntmains(url, strings.TrimRight(Api_GetSmtCodeEvtTxsByHgt, ":height")) {
