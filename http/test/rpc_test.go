...
func TestRpcGetCcntmract(t *testing.T) {
	var req = reqPacking("getccntmractstate", []interface{}{"ff00000000000000000000000000000000000001"})
	q, _ := json.Marshal(req)
	fmt.Println(string(q))
	resp, err := Request("POST", req, "http://127.0.0.1:20386")
	if err != nil {
...
func TestRpcGetEventByHeight(t *testing.T) {
	var req = reqPacking("getccntmractstate", []interface{}{1})
	q, _ := json.Marshal(req)
	fmt.Println(string(q))
	resp, err := Request("POST", req, "http://127.0.0.1:20386")
	if err != nil {
