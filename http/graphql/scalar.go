...
func (t *Uint32) UnmarshalGraphQL(input interface{}) error {
	...
	case int64:
		*t = Uint32(input)
		return nil
	default:
		return fmt.Errorf("wrcntm type for Uint32: %T", input)
	}
}
...
func (t *Uint64) UnmarshalGraphQL(input interface{}) error {
	...
	case string:
		...
		if err != nil {
			return fmt.Errorf("wrcntm type for Uint64: %T", input)
		}
		*t = Uint64(val)
	default:
		return fmt.Errorf("wrcntm type for Uint64: %T", input)
...
func (t *Addr) UnmarshalGraphQL(input interface{}) error {
	...
	default:
		return fmt.Errorf("wrcntm type for Address: %T", input)
	}
	return err
}
...
func (t *H256) UnmarshalGraphQL(input interface{}) error {
	...
	case string:
		...
		*t = H256(hash)
		return nil
	default:
		return fmt.Errorf("wrcntm type for H256: %T", input)
	}
}
...
func (key *PubKey) UnmarshalGraphQL(input interface{}) error {
	...
	case string:
		...
		*key = PubKey(input)
		return nil
	default:
		return fmt.Errorf("wrcntm type for PubKey: %T", input)
	}
}
