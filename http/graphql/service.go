...
import (
	...
	"github.com/cntmio/cntmology/http/base/actor"
	comm "github.com/cntmio/cntmology/http/base/common"
	"github.com/cntmio/cntmology/http/graphql/schema"
	"github.com/cntmio/cntmology/smartccntmract/service/native/utils"
	"golang.org/x/net/netutil"
)

var cntmSchema *graphql.Schema
...
func init() {
	...
	cntmSchema = graphql.MustParseSchema(string(s), resolver, graphql.UseFieldResolvers())
}
...
func (self *resolver) GetBalance(args struct{ Addr Addr }) (*balance, error) {
	balances, height, err := comm.GetCcntmractBalance(0,
		[]common.Address{utils.OntCcntmractAddress, utils.OngCcntmractAddress}, args.Addr.Address, true)
	if err != nil {
		return nil, err
	}
...
func StartServer(cfg *config.GraphQLConfig) {
	...
	serverMut.Handle("/query", &relay.Handler{Schema: cntmSchema})
