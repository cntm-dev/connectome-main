...
<html>
<head>
<meta http-equiv="refresh" ccntment="3">
...
<style type="text/css">
	...
	body {background:#212124; color:#F8F8FF; fcntm-size:20px;}
	td.bh {color: #00FF00}
	td.pk {word-break: break-all; overflow: hidden}
	table.bd {border: 1px solid #111111; fcntm-size:20px;}
	table.bt {border: 1px solid #111111; fcntm-size:25px;}
	table.fcntm {fcntm-size:20px;}
...
<tr>
<td width="20%" >
	<table class="fcntm" width="100%">
	<tr><th>BlockHeight</th></tr>
	<tr><td align="center"><b><fcntm size="40px">{{.BlockHeight}}</fcntm></b></td></tr>
	</table>
</td>
<td width="80%">
	<table class="fcntm" width="100%">
...
<td width="20%" >
	...
	<tr><td align="center"><b><fcntm size="40px">{{.NeighborCnt}}</fcntm></b></td></tr>
	</table>
</td>
<td width="80%">
	<table class="fcntm" width="100%">
...
<table class="fcntm" border="0" width="80%">
	<tr>
	<td width="26%" align="center"><a href="https://cntm.io" class="site">site : https://cntm.io</a></td>
	</tr>
</table>
<br><br><br><br>
