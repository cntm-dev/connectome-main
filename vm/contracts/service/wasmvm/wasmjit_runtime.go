...
import (
	...
	states2 "github.com/conntectome/cntm/core/states"
...
//export conntectome_contract_create_cgo
func conntectome_contract_create_cgo(serviceIndex C.uint64_t,
	codeSlice C.wasmjit_slice_t,
	vmType C.uint32_t,
	nameSlice C.wasmjit_slice_t,
	verSlice C.wasmjit_slice_t,
...
//export conntectome_contract_migrate_cgo
func conntectome_contract_migrate_cgo(serviceIndex C.uint64_t,
	codeSlice C.wasmjit_slice_t,
	vmType C.uint32_t,
	nameSlice C.wasmjit_slice_t,
	verSlice C.wasmjit_slice_t,
...
//export conntectome_contract_destroy_cgo
func conntectome_contract_destroy_cgo(service_index C.uint64_t) C.wasmjit_result_t {
...
//export conntectome_storage_read_cgo
func conntectome_storage_read_cgo(serviceIndex C.uint64_t, keySlice C.wasmjit_slice_t, valSlice C.wasmjit_slice_t, offset C.uint32_t) C.wasmjit_u32 {
	service := getWasmVmService(uint64(serviceIndex))
...
//export conntectome_storage_write_cgo
func conntectome_storage_write_cgo(service_index C.uint64_t, key_s C.wasmjit_slice_t, val_s C.wasmjit_slice_t) {
	service := getWasmVmService(uint64(service_index))
...
//export conntectome_storage_delete_cgo
func conntectome_storage_delete_cgo(service_index C.uint64_t, key_s C.wasmjit_slice_t) {
	service := getWasmVmService(uint64(service_index))
	keybytes := jitSliceToBytes(key_s)
...
//export conntectome_notify_cgo
func conntectome_notify_cgo(service_index C.uint64_t, data C.wasmjit_slice_t) C.wasmjit_result_t {
	service := getWasmVmService(uint64(service_index))
...
//export conntectome_debug_cgo
func conntectome_debug_cgo(data C.wasmjit_slice_t) {
	bs := jitSliceToBytes(data)
	debugLog(bs)
}

//export conntectome_call_contract_cgo
func conntectome_call_contract_cgo(vmctx *C.wasmjit_vmctx_t, contractAddr *C.address_t, input C.wasmjit_slice_t) C.wasmjit_result_t {
