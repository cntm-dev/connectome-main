...
func (this *InitContractAdminParam) Serialization(sink *common.ZeroCopySink) {
	sink.WriteVarBytes(this.Admincntmid)
}

func (this *InitContractAdminParam) Deserialization(source *common.ZeroCopySource) error {
	var irregular, eof bool
	this.Admincntmid, _, irregular, eof = source.NextVarBytes()
	if irregular {
...
func (this *TransferParam) Serialization(sink *common.ZeroCopySink) {
	...
	sink.WriteVarBytes(this.NewAdmincntmid)
...
func (this *TransferParam) Deserialization(source *common.ZeroCopySource) error {
	...
	var irregular, eof bool
	if this.NewAdmincntmid, _, irregular, eof = source.NextVarBytes(); irregular || eof {
...
func (this *FuncsToRoleParam) Deserialization(source *common.ZeroCopySource) error {
	...
	if this.Admincntmid, err = utils.DecodeVarBytes(source); err != nil {
		return fmt.Errorf("Admincntmid Deserialization error: %s", err)
	}
...
type cntmidsToRoleParam struct {
	ContractAddr common.Address
	Admincntmid   []byte
	Role         []byte
	Persons      [][]byte
...
func (this *cntmidsToRoleParam) Serialization(sink *common.ZeroCopySink) {
	serializeAddress(sink, this.ContractAddr)
	sink.WriteVarBytes(this.Admincntmid)
	sink.WriteVarBytes(this.Role)
...
func (this *cntmidsToRoleParam) Deserialization(source *common.ZeroCopySource) error {
	var err error
	var pLen uint64
	if this.ContractAddr, err = utils.DecodeAddress(source); err != nil {
		return err
