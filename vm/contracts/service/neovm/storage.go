...
func StoragePut(service *CntmVmService, engine *vm.Executor) error {
...
func StorageDelete(service *CntmVmService, engine *vm.Executor) error {
	context, err := getContext(engine)
	if err != nil {
...
func StorageGet(service *CntmVmService, engine *vm.Executor) error {
...
func StorageGetContext(service *CntmVmService, engine *vm.Executor) error {
	return engine.EvalStack.PushAsInteropValue(NewStorageContext(service.ContextRef.CurrentContext().ContractAddress))
}

func StorageGetReadOnlyContext(service *CntmVmService, engine *vm.Executor) error {
...
func checkStorageContext(service *CntmVmService, context *StorageContext) error {
