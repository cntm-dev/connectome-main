...
import (
	...
	svm "github.com/conntectome/cntm/smartcontract/service/cntmvm"
	vtypes "github.com/conntectome/cntm/vm/cntmvm/types"
)
...
func TestVerifySig(t *testing.T) {
	...
	Cversion = '2.0.0'
	from cntm.interop.Cntm.Runtime import VerifyMutiSig
	...
	**/
	...
	var service *svm.CntmVmService
	service = engine.(*svm.CntmVmService)
	e := service.Engine
