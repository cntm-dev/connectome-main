...
func TestBuildParamToNative(t *testing.T) {
	...
	assert.Error(t, err, "invoke smart contract err: [CntmVmService] service system call error!: [SystemCall] service execute error!: invoke native circular reference!")
}
