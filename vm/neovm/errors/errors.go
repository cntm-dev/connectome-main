...
var (
	...
	ERR_EXECUTION_CCNTMEXT_NIL    = errors.New("execution context is nil")
	ERR_CURRENT_CCNTMEXT_NIL      = errors.New("current context is nil")
	ERR_CALLING_CCNTMEXT_NIL      = errors.New("calling context is nil")
	ERR_ENTRY_CCNTMEXT_NIL        = errors.New("entry context is nil")
