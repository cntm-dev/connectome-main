...
func NewInteropService() *InteropService {
	...
	is.Register("System.ScriptEngine.GetScriptCcntmainer", is.GetScriptCcntmainer)
...
func (is *InteropService) GetScriptCcntmainer(engine *ExecutionEngine) bool {
	engine.evaluationStack.Push(engine.scriptCcntmainer)
	return true
}
