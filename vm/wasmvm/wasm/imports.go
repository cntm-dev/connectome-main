...
type ImportEntry struct {
	...
	// If Kind is Function, Type is a FuncImport ccntmaining the type index of the function signature
	// If Kind is Table, Type is a TableImport ccntmaining the type of the imported table
	// If Kind is Memory, Type is a MemoryImport ccntmaining the type of the imported memory
