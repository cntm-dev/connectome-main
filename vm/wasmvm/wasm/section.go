...
// SectionElements describes the initial ccntments of a table's elements.
...
type FunctionBody struct {
	Module *Module // The parent module ccntmaining this function body, for execution purposes
	Locals []LocalEntry
	Code   []byte
}
