...
//todo add parameters
func NewExecutionEngine(iccntmainer interfaces.ICodeCcntmainer, icrypto interfaces.ICrypto, itable interfaces.ICodeTable, iservice IInteropService) *ExecutionEngine {
