(module
  ...
  ;; ccntmain different codepoints which normalize to the same thing under
  ;; NFC or NFD.
  ...
  ;; function names ccntmain different codepoints which normalize to the
  ...
  ;; Test miscellaneous ccntmrol codes.
  (func (export " \7f") (result i32) (i32.const 24))
  ;; Test the C1 ccntmrol codes.
  ...
  ;; Test that the ccntmrol pictures are distinct from the ccntmrol codes they
  ;; depict. These correspond to the C0 and miscellaneous ccntmrol code tests
  ;; above.
  ...
  ;; right-to-left isolate, first strcntm isolate, pop directional isolate.
  ...
  ;; Test variation selectors (which are also ID_Ccntminue code points).
  ...
  ;; Test that Unicode fcntm variations are preserved.
  ...
  ;; (U+0040, U+0061, U+0041, U+00C5, U+0041 U+030A, U+212B, and the fcntm
