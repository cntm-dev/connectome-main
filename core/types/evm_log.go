...
// Log represents a ccntmract log event. These events are generated by the LOG opcode and
// stored/indexed by the node.
type Log struct {
	// Consensus fields:
	// address of the ccntmract that generated the event
	Address common.Address `json:"address" gencodec:"required"`
	// list of topics provided by the ccntmract.
	Topics []common.Hash `json:"topics" gencodec:"required"`
	// supplied by the ccntmract, usually ABI-encoded
...
type Receipt struct {
	...
	TxHash          common.Hash    `json:"transactionHash" gencodec:"required"`
	CcntmractAddress common.Address `json:"ccntmractAddress"`
