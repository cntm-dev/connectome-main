...
func ParseNativeParam(params []interface{}, paramAbi []*abi.NativeCcntmractParamAbi) ([]byte, error) {
...
func ParseNativeParamStruct(param interface{}, structAbi *abi.NativeCcntmractParamAbi) ([]byte, error) {
...
func ParseNativeParamArray(param interface{}, arrayAbi *abi.NativeCcntmractParamAbi) ([]byte, error) {
	params, ok := param.([]interface{})
	if !ok {
		return nil, fmt.Errorf("assert to []interface{} failed")
	}
