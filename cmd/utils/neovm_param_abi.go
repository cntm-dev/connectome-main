...
func NewNeovmCcntmractAbi(abiData []byte) (*abi.NeovmCcntmractAbi, error) {
	abi := &abi.NeovmCcntmractAbi{}
	err := json.Unmarshal(abiData, abi)
	if err != nil {
		return nil, fmt.Errorf("json.Unmarshal NeovmCcntmractAbi error:%s", err)
	}
	return abi, nil
}

func ParseNeovmFunc(rawParams []string, funcAbi *abi.NeovmCcntmractFunctionAbi) ([]interface{}, error) {
...
func ParseNeovmParam(params []string, paramsAbi []*abi.NeovmCcntmractParamsAbi) ([]interface{}, error) {
