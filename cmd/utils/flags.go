...
var (
	...
	CcntmractStorageFlag = cli.BoolFlag{
		Name:  "needstore",
		Usage: "Is need use store in ccntmract",
	}
	...
	CcntmranctReturnTypeFlag = cli.StringFlag{
		Name:  "return",
		Usage: "Return type of ccntmract. 0:bytearray(hexstring), 1:string, 2:integer, 3:boolean. If return type is object array, enclose array with '[]'. For example [1,0,2,3]. Only prepare invoke need this flag.",
	}
