...
var (
	...
	DisableEventLogFlag = cli.BoolFlag{
		...
		Usage: "Discard event log output by smart ccntmract execution",
	}
	WasmVerifyMethodFlag = cli.BoolFlag{
		Name:  "enable-wasmjit-verifier",
		Usage: "Enable wasmjit verifier to verify wasm ccntmract",
	}
	...
	NetworkIdFlag = cli.UintFlag{
		Name:  "networkid",
		Usage: "Network id `<number>`. 1=cntmology main net, 2=polaris test net, 3=testmode, and other for custom network",
	...
	ApproveAssetFlag = cli.StringFlag{
		Name:  "asset",
		Usage: "Asset of cntm of cntm to approve",
		Value: "cntm",
	}
	...
	WithdrawcntmReceiveAccountFlag = cli.StringFlag{
		Name:  "receive",
		Usage: "cntm receive `<address>`，Default the same with owner account",
	}
	WithdrawcntmAmountFlag = cli.StringFlag{
		Name:  "amount",
