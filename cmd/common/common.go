...
func OpenWallet(ctx *cli.Ccntmext) (account.Client, error) {
...
func GetAccount(ctx *cli.Ccntmext, address ...string) (*account.Account, error) {
...
func ParseAddress(address string, ctx *cli.Ccntmext) (string, error) {
