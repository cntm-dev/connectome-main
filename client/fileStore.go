...
func (cs * FileStore) LoadCcntmractData( index int ) ([]byte,[]byte,[]byte,error) {
...
func (cs * FileStore) SaveCcntmractData( ct * ct.Ccntmract) error {
	...
	//fmt.Printf("[SaveCcntmractData]->[Ccntmract] ScriptHash: %s\n", cs.fd.ScriptHash)
	//fmt.Printf("[SaveCcntmractData]->[Ccntmract] PublicKeyHash: %s\n", cs.fd.PublicKeyHash)
	//fmt.Printf("[SaveCcntmractData]->[Ccntmract] RawData: %s\n", cs.fd.RawData)
...
/*
	...
	//fmt.Printf("[SaveCcntmractData]->[Address] ScriptHash: %x\n", sh)
...
*/
	//fmt.Printf("[SaveCcntmractData]->[Ccntmract] ScriptHash: %x\n", sh)
	//fmt.Printf("[SaveCcntmractData]->[Ccntmract] PublicKeyHash: %x\n", ph)
	//fmt.Printf("[SaveCcntmractData]->[Ccntmract] RawData: %x\n", rd)
	//fmt.Printf("[SaveCcntmractData] Code: %x\n", ct.Code)
	//fmt.Printf("[SaveCcntmractData] Parameters: %x\n", ct.Parameters)
