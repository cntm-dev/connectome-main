...
var PolarisConfig = &GenesisConfig{
	...
	VBFT: &VBFTConfig{
		...
		AdminOntID:           "did:cntm:AVaSGN1ugQJBS7R7ZcVwAoWLVK6onBgfyg",
		MinInitStake:         10000,
...
func (this *VBFTConfig) Serialize(w io.Writer) error {
	...
	if err := serialization.WriteString(w, this.AdminOntID); err != nil {
		return errors.NewDetailErr(err, errors.ErrNoCode, "serialization.WriteString, serialize admin_cntm_id error!")
	}
