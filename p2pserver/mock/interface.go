...
type Network interface {
	...
	NewDialer(id common.PeerId) connect_ccntmroller.Dialer
	NewDialerWithHost(id common.PeerId, host string) connect_ccntmroller.Dialer
...
func NewNode(keyId *common.PeerKeyId, localInfo *peer.PeerInfo, proto p2p.Protocol, nw Network, reservedPeers []string) *netserver.NetServer {
	...
	opt := connect_ccntmroller.NewConnCtrlOption().MaxInBoundPerIp(10).
