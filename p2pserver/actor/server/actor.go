...
//message handler
func (this *P2PActor) Receive(ctx actor.Ccntmext) {
...
//start handler
func (this *P2PActor) handleStartServerReq(ctx actor.Ccntmext, req *StartServerReq) {
...
//stop handler
func (this *P2PActor) handleStopServerReq(ctx actor.Ccntmext, req *StopServerReq) {
...
//get port handler
func (this *P2PActor) handleGetPortReq(ctx actor.Ccntmext, req *GetPortReq) {
...
//version handler
func (this *P2PActor) handleGetVersionReq(ctx actor.Ccntmext, req *GetVersionReq) {
...
func (this *P2PActor) handleGetConnectionCntReq(ctx actor.Ccntmext, req *GetConnectionCntReq) {
...
//sync port handler
func (this *P2PActor) handleGetSyncPortReq(ctx actor.Ccntmext, req *GetSyncPortReq) {
	var syncPort uint16
	//TODO
	if ctx.Sender() != nil {
		resp := &GetSyncPortRsp{
...
func (this *P2PActor) handleGetConsPortReq(ctx actor.Ccntmext, req *GetConsPortReq) {
	var consPort uint16
	//TODO
	if ctx.Sender() != nil {
		resp := &GetConsPortRsp{
...
//get id handler
func (this *P2PActor) handleGetIDReq(ctx actor.Ccntmext, req *GetIdReq) {
...
func (this *P2PActor) handleGetConnectionStateReq(ctx actor.Ccntmext, req *GetConnectionStateReq) {
...
//timestamp handler
func (this *P2PActor) handleGetTimeReq(ctx actor.Ccntmext, req *GetTimeReq) {
...
func (this *P2PActor) handleGetNeighborAddrsReq(ctx actor.Ccntmext, req *GetNeighborAddrsReq) {
...
func (this *P2PActor) handleGetRelayStateReq(ctx actor.Ccntmext, req *GetRelayStateReq) {
...
func (this *P2PActor) handleGetNodeTypeReq(ctx actor.Ccntmext, req *GetNodeTypeReq) {
