...
import (
	...
	ldg "github.com/cntmio/cntmology/core/ledger"
	ledger "github.com/cntmio/cntmology/core/ledger/actor"
...
func IsCcntmainBlock(hash common.Uint256) (bool, error) {
	future := DefLedgerPid.RequestFuture(&ledger.IsCcntmainBlockReq{BlockHash: hash}, msgCommon.ACTOR_TIMEOUT*time.Second)
	result, err := future.Result()
	if err != nil {
		log.Error(errors.NewErr("net_server IsCcntmainBlock ERROR: "), err)
		return false, err
	}
