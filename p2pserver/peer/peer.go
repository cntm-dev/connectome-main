...
import (
	...
	conn "github.com/cntmio/cntmology/p2pserver/link"
)
...
//GetTimeStamp return peer`s latest ccntmact time in ticks
...
//GetCcntmactTime return peer`s latest ccntmact time in Time struct
func (this *Peer) GetCcntmactTime() time.Time {
	if this != nil {
