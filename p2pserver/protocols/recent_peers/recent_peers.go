 ...
 *
 * You should ccntmains received a copy of the GNU Lesser General Public License
...
func (this *PersistRecentPeerService) ccntmains(addr string) bool {
	this.lock.RLock()
