...
func constructConfig() (*config.CbftConfig, error) {
	conf := &config.CbftConfig{
		N:                    7,
		C:                    2,
		K:                    7,
		L:                    112,
