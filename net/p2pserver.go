...
import (
	...
	evtActor "github.com/conntectome/cntm-eventbus/actor"
	...
	msgpack "github.com/conntectome/cntm/p2pserver/message/msg_pack"
	msgtypes "github.com/conntectome/cntm/p2pserver/message/types"
	"github.com/conntectome/cntm/p2pserver/message/utils"
...
func (this *P2PServer) reachMinConnection() bool {
	...
	case "Cbft":
		minCount = config.Cbft_MIN_NODE_NUM
